 ...
 */
class ChickAdapter(
    private val elements: List<ChickContentDto>,
    private val onItemDone: (Int) -> Unit
) :
    RecyclerView.Adapter<ChickViewHolder>() {

    /**
     * Se ocupa de decir donde esta la vista (XML) para poder generarla y la devuelve.
     */
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChickViewHolder {
        val layoutInflater: LayoutInflater = LayoutInflater.from(parent.context)
        return ChickViewHolder(layoutInflater.inflate(R.layout.item_chick, parent, false))
    }
     ...
     */
    override fun onBindViewHolder(holder: ChickViewHolder, position: Int) {
